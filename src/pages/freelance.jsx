...
import useAppear from '~utils/behaviors/useAppear'
...
const Freelance = () => {
  const showTitle = useAppear()

  return (
    <Layout>
      <SEO title="Freelance" />
      <Section className={style.FreelanceWelcome}>
        <h1 className={style.title}>
          <div className={`${style.div} ${showTitle ? style.appear : ''}`}>
            Freelance
          </div>
        </h1>
      </Section>
        ...
        <div className={style.missionList}>
          ...
          <div className={`${style.mission} ${style.mission3}`}>
            <div className={style.content}>
              ...
              <div className={style.description}>
                You have an idea and you want a user-friendly and finished
                product ?
                <div>
                  <Link
                    className={`${style.button} ${style.more}`}
      ...
      <Section title="My key strenghs" three>
        <ul className={style.list}>
          <li className={style.item}>
            <h3>Polyvalence</h3>
            <p>
              I am very curious and always try to learning new technologies. So
              I can now work with a lot of technologies and methods.
            </p>
          </li>
          <li className={style.item}>
            <h3>Empathy</h3>
            <p>
              I am able to empathize customer feelings. It makes me very
              efficient to improve user experiences or design new ones.
            </p>
          </li>
          <li className={style.item}>
            <h3>Performance</h3>
