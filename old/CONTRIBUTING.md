...
Thank you for reporting any issues you find. We do our best to test and make `portfolio` as solid as possible, but any reported issue is a real help.
...
- Provide the exact version of portfolio.
- Be awesome and consider contributing a [pull request](#want-to-contribute)

## Want to contribute?

You consider contributing changes to portfolio – we dig that!
...
- Consider your development for windows, linux and macOS platforms at the same time
  because having a module compatible with all platforms is the main concern of `portfolio`.
...
`portfolio` use [standard-version](https://github.com/conventional-changelog/standard-version) to handle versioning
